...
from users.models import CollectRecord
...
def CollectDatacenterinfo(host,user,pwd):
    ...
    try:
        ...
        CollectRecord.objects.create(host=host,collect_time=datetime.now(),type='datacenter')
        return "Datacenter---%s数据采集成功" %host
    except Exception as e:
        print(e)
        CollectRecord.objects.create(host=host,collect_time=datetime.now(),type='datacenter',result=e)
        return "Datacenter---%s数据采集失败" %host
...
def CollectClusterinfo(host,user,pwd):
    ...
    try:
        ...
        CollectRecord.objects.create(host=host,collect_time=datetime.now(),type='cluster')
        return "Cluster-----%s数据采集成功"  %host
    except Exception as e:
        print(e)
        CollectRecord.objects.create(host=host, collect_time=datetime.now(), type='cluster',result=e)
        return "Cluster-----%s数据采集失败" % host
...
def CollectDatastoreinfo(host,user,pwd):
    ...
    try:
        ...
        CollectRecord.objects.create(host=host,collect_time=datetime.now(),type='datastore')
        return "Datastore------%s数据采集成功" %host
    except Exception as e:
        print(e)
        CollectRecord.objects.create(host=host, collect_time=datetime.now(), type='datastore',result=e)
        return "Datastore------%s数据采集失败" % host
...
def CollectNetworkinfo(host,user,pwd):
    ...
    try:
        ...
        CollectRecord.objects.create(host=host,collect_time=datetime.now(),type='network')
        return "Network-----%s数据采集成功"  %host
    except Exception as e:
        print(e)
        CollectRecord.objects.create(host=host, collect_time=datetime.now(), type='network',result=e)
        return "Network-----%s数据采集失败" % host
...
def CollectVirtualinfo(host,user,pwd):
    ...
    try:
        ...
        CollectRecord.objects.create(host=host,collect_time=datetime.now(),type='virtualhost')
        return  "Virtualhost-----%s数据采集成功"  %host
    except Exception as e:
        print(e)
        CollectRecord.objects.create(host=host, collect_time=datetime.now(), type='virtualhost',result=e)
        return "Virtualhost-----%s数据采集失败" % host
    ...
    try:
        ...
        for item in res:
            ...
            try:
                ...
                obj.first().save()
        CollectRecord.objects.create(host=host,collect_time=datetime.now(),type='physicshost')
        return "Physicshost----%s采集成功"  %host
    except Exception as e:
        print(e)
        CollectRecord.objects.create(host=host, collect_time=datetime.now(), type='physicshost',result=e)
        return "Physicshost----%s采集失败" % host