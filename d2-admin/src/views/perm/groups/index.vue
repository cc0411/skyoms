<template>
  <d2-container type="card">
    <template slot="header">用户组</template>
    <div class="header-class">
      <el-row :gutter="20">
        <el-col :span="6"><div class="grid-content bg-purple">
          <el-button type="primary" size="mini" round @click="dialogVisibleCreate = true">创建用户组</el-button>
        </div>
        </el-col>
        <el-col :span="12"><div class="grid-content bg-purple"></div></el-col>
        <el-col :span="6">
          <div class="grid-content bg-purple">
            <el-input v-model="params.name" placeholder="请输入内容" size="mini" class="input-with-select" @keyup.enter.native="handleFilter">
...
<script>
import { getGroupList, createGroup, updateGroup, deleteGroup, deleteGroupMember, getPermission, updateGroupPerm } from '@/api/user'
