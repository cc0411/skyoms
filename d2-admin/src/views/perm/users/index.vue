<template>
  <d2-container type="card">
    <template slot="header">用户</template>
    <div class="header-class">
      <el-row :gutter="20">
        <el-col :span="6"><div class="grid-content bg-purple">
          <el-button type="primary" size="mini" round @click="dialogVisibleCreate = true">创建用户</el-button>
        </div>
        </el-col>
        <el-col :span="12"><div class="grid-content bg-purple"></div></el-col>
        <el-col :span="6">
          <div class="grid-content bg-purple">
            <el-input v-model="params.keywords" size="mini" placeholder="请输入内容" class="input-with-select" @keyup.enter.native="handleFilter">
...
<script>
import { getUserList, createUser, updateUser, deleteUser, updateUserGroup, changeUserPass ,getGroupList} from '@api/user'
import UserList from './user-list'
import UserForm from './user-form'
import UpdateUgroup from './update-group'
